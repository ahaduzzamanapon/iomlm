...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: 'Kalpurush', 'Inter', 'Noto Sans Bengali', sans-serif; background: #f8fafc; color: #0f172a; min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 20px; }
    .card { background: #fff; border-radius: 16px; border: 1px solid #d1fae5; border-top: 4px solid #047857; box-shadow: 0 10px 25px -5px rgba(6,78,59,.08); max-width: 540px; width: 100%; text-align: center; padding: 40px 32px; }
    .icon { width: 64px; height: 64px; border-radius: 50%; background: linear-gradient(135deg, #047857, #064e3b); color: #fff; font-size: 28px; display: flex; align-items: center; justify-content: justify; margin: 0 auto 20px; align-items: center; justify-content: center; }
    ...
    .app-box { background: #ecfdf5; border: 1.5px dashed #a7f3d0; border-radius: 10px; padding: 14px; margin-bottom: 24px; }
    .app-no { font-size: 20px; font-weight: 700; color: #047857; font-family: monospace; letter-spacing: 1px; }
