...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .icon { width: 64px; height: 64px; border-radius: 50%; background: #dcfce7; color: #166534; font-size: 32px; display: flex; align-items: center; justify-content: justify; margin: 0 auto 20px; align-items: center; justify-content: center; }
