<x-teacher-layout>
    ...
    <style>
        ...
        .calendar-day-cell.today { background:rgba(16,185,129,0.05); }
        ...
        .calendar-day-cell.today .day-number { background:#10b981; color:#fff; }
        ...
        .event-scheduled { background:linear-gradient(135deg, #10b981, #059669); color:#fff; }
    ...
    <div class="page-header">
        <div class="page-header-left">
            <h1>Teacher Interactive Class Calendar</h1>
            <p>Google Calendar-style schedule manager for conducted & upcoming classes</p>
        </div>
    </div>
        ...
        <div class="modal">
            ...
            <div class="modal-body" style="font-size:13px">
                ...
                <table class="table" style="margin-bottom:0">
                    ...
                    <tr><th style="color:var(--text-muted)">Batch Cohort:</th><td id="m_batch_name"></td></tr>
            ...
            <div class="modal-footer" id="m_footer_action">
                ...
                <a id="m_conduct_btn" href="#" class="btn btn-primary">▶ Conduct Class</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function renderCalendar() {
            ...
            for (let day = 1; day <= daysInMonth; day++) {
                ...
                matchingEvents.forEach(evt => {
                    const color = evt.color || (evt.status === 'COMPLETED' ? '#94a3b8' : '#3b82f6');
        ...
        function openEventModal(evt) {
            ...
            document.getElementById('m_batch_name').innerText = evt.batch_name;
            ...
            const conductBtn = document.getElementById('m_conduct_btn');
            if (evt.status === 'SCHEDULED' || evt.status === 'RUNNING') {
                conductBtn.href = '/teacher/classes/' + evt.id + '/conduct';
                conductBtn.style.display = 'inline-flex';
            } else {
                conductBtn.style.display = 'none';
            }
