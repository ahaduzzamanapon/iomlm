                    ...
                    <table style="width:100%; border-collapse:collapse; font-size:13px">
                        <thead>
                            <tr style="background:#f8fafc; border-bottom:2px solid #e2e8f0">
                                <th style="padding:12px 10px; text-align:center; width:60px">মেধাক্রম</th>
                                <th style="padding:12px 14px; text-align:left">রোল ও শিক্ষার্থী</th>
                                <th style="padding:12px 12px; text-align:left">বিষয় ও ব্যাচ</th>
                                ...
                                <th style="padding:12px 8px; text-align:center">প্রকাশিত?</th>
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid #f1f5f9; transition:background .15s" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                                ...
                                <td style="padding:14px 12px">
                                    <div style="font-weight:700; color:#1e293b">{{ $fm->subject->name ?? '—' }}</div>
                                    <div style="font-size:11.5px; color:#64748b">
                                        {{ $fm->batch->name ?? '—' }} {{ $fm->semester ? "({$fm->semester->name})" : '' }}
                                    </div>
                                </td>
                                <td style="padding:14px 8px; text-align:center; font-weight:700">
                                ...
                                <td style="padding:14px 8px; text-align:center">
                                    @if($fm->is_published)
                                        <span style="color:#15803d; font-weight:800; font-size:11.5px"><i class="fa-solid fa-check"></i> হ্যাঁ</span>
                                    @else
                                        <span style="color:#94a3b8; font-size:11.5px">না</span>
                                    @endif
                                </td>
                                <td style="padding:14px 10px; text-align:center">
                                    <div style="display:inline-flex; gap:6px; align-items:center">
                                        ...
                                        <a href="{{ route('admin.students.transcript', $fm->student_id) }}" target="_blank"
                                           style="padding:4px 9px; background:#f0fdf4; border:1px solid #86efac; color:#15803d; border-radius:6px; text-decoration:none; font-size:11px; font-weight:700"
        ...
        <div class="modal-card" style="max-width:560px">
            <div style="padding:16px 20px; background:#1e40af; color:#fff; display:flex; justify-content:space-between; align-items:center">
                <h3 style="margin:0; font-size:16px; font-weight:800; display:flex; align-items:center; gap:8px">
                    <i class="fa-solid fa-pen-to-square"></i> রেজাল্ট বুক: নম্বর সংশোধন ও ওভাররাইড
                </h3>
            ...
            <form id="overrideForm" method="POST" action="" style="padding:20px 22px">
                ...
                <div style="margin-bottom:14px; background:#f8fafc; padding:10px 14px; border-radius:10px; border:1px solid #e2e8f0">
                    ...
                    <span id="ovStudentRoll" style="font-size:12px; color:#2563eb; font-weight:700"></span>
                </div>
                ...
                <div style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap:10px; margin-bottom:14px">
                    <div>
                        ...
                        <input type="number" step="0.1" min="0" max="100" name="class_test_converted" id="ovCt" class="form-control" style="height:38px">
                    </div>
                    <div>
                        <label style="font-size:12px; font-weight:700; color:#1e293b; display:block; margin-bottom:4px">মিডটার্ম রূপান্তর</label>
                        <input type="number" step="0.1" min="0" max="100" name="midterm_converted" id="ovMid" class="form-control" style="height:38px">
                    </div>
                    <div>
                        <label style="font-size:12px; font-weight:700; color:#1e293b; display:block; margin-bottom:4px">ফাইনাল রূপান্তর</label>
                        <input type="number" step="0.1" min="0" max="100" name="final_converted" id="ovFinal" class="form-control" style="height:38px">
                    </div>
                </div>
                ...
                <div style="margin-bottom:14px">
                    ...
                    <input type="number" step="0.1" min="0" max="100" name="attendance_converted" id="ovAtt" class="form-control" style="height:38px">
                </div>
