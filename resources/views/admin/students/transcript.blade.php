...
<body>
    ...
    <div style="max-width:960px; margin:0 auto 16px; display:flex; justify-content:space-between; align-items:center" class="no-print">
        <a href="javascript:history.back()" style="background:#e2e8f0; color:#1e293b; padding:8px 18px; border-radius:8px; text-decoration:none; font-weight:700; font-size:13px">
            ← ফিরে যান (Back)
        </a>
