<x-admin-layout>
    ...
    <div class="page-header">
        <div class="page-header-left">
            <div style="font-size:12px;color:var(--text-muted);margin-bottom:4px">
                <a href="{{ route('admin.assignments.index') }}"><i class="fa-solid fa-arrow-left"></i> সকল অ্যাসাইনমেন্টে ফিরে যান</a>
            </div>
            ...
            <p>
                ...
                ব্যাচ: <strong>{{ $assignment->batch?->name ?? 'উন্মুক্ত (সকল ব্যাচ)' }}</strong> &middot;
        ...
        <div class="page-header-actions">
            @if($assignment->file_path)
                <a href="{{ asset('storage/' . $assignment->file_path) }}" target="_blank" class="btn btn-outline" style="display:inline-flex;align-items:center;gap:6px">
                    <i class="fa-solid fa-download"></i> প্রশ্নপত্র ডাউনলোড
                </a>
            @endif
        </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(180px, 1fr));gap:14px;margin-bottom:20px">
        ...
        <div class="card" style="padding:16px;text-align:center">
            <span style="font-size:12px;color:#64748b">বিলম্বিত জমা (Late)</span>
            <div style="font-size:24px;font-weight:800;color:#dc2626;margin-top:4px">{{ $assignment->submissions->where('status', 'LATE')->count() }}টি</div>
        </div>
    </div>

    @if($assignment->instructions)
        <div class="card" style="margin-bottom:20px;padding:16px;background:#f8fafc;border-left:4px solid #6366f1">
            <strong style="font-size:13px;color:#334155"><i class="fa-solid fa-circle-info"></i> অ্যাসাইনমেন্টের নির্দেশনাবলী:</strong>
            <p style="margin:6px 0 0;font-size:13px;color:#475569;white-space:pre-line">{{ $assignment->instructions }}</p>
        </div>
    @endif
    ...
    <div class="card">
        <div class="card-header" style="display:flex;justify-content:space-between;align-items:center">
            <span class="card-title">শিক্ষার্থীদের জমাকৃত খাতা (Student Submissions)</span>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>আইডি (Student Code)</th>
                        <th>জমাকৃত ফাইল</th>
                        <th>শিক্ষার্থীর নোট</th>
                        <th>জমার সময়</th>
                        <th>প্রাপ্ত নম্বর</th>
                        <th>শিক্ষকের মন্তব্য</th>
                        <th>স্ট্যাটাস</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="td-primary">
                            ...
                            <div style="font-size:11px;color:#64748b">{{ $sub->student?->phone }}</div>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            @else
                                <span class="badge" style="background:#fef3c7;color:#92400e;font-size:11px">বাকি আছে</span>
                            @endif
                        </td>
                        <td style="max-width:180px;font-size:12px;color:#64748b">
                        ...
                        <td style="text-align:right;white-space:nowrap">
                            ...
                            <button type="button" class="btn btn-outline btn-sm" onclick='openOverrideModal(@json($sub))' title="অ্যাডমিন ওভাররাইড" style="color:#6366f1;border-color:#c7d2fe">
                                <i class="fa-solid fa-pen-nib"></i> ওভাররাইড
                            </button>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="9" style="text-align:center;padding:40px;color:var(--text-muted)">
                            এখনো কোনো শিক্ষার্থী এই অ্যাসাইনমেন্ট জমা দেয়নি।
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div class="modal-overlay" id="gradeModal">
        <div class="modal">
            <div class="modal-header">
                <span class="modal-title">অ্যাসাইনমেন্ট মূল্যায়ন ও নম্বর প্রদান</span>
            ...
            <form method="POST" id="gradeForm" action="">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>প্রাপ্ত নম্বর (Obtained Marks) <span class="required">*</span></label>
                    ...
                    <div class="form-group">
                        <label>শিক্ষকের মন্তব্য / মূল্যায়ন ফিডব্যাক</label>
                        <textarea name="teacher_feedback" id="gm_teacher_feedback" class="form-control" rows="3" placeholder="শিক্ষার্থীর জন্য নির্দেশনা বা ফিডব্যাক লিখুন..."></textarea>
                    </div>
                </div>
    ...
    <div class="modal-overlay" id="overrideModal">
        <div class="modal" style="max-width:600px">
            <div class="modal-header">
                <span class="modal-title">অ্যাডমিন সাবমিশন ওভাররাইড (Override Submission)</span>
            ...
            <form method="POST" id="overrideForm" action="" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div style="background:#fef3c7;border:1px solid #fde68a;color:#92400e;padding:10px 14px;border-radius:8px;margin-bottom:14px;font-size:13px">
                        <i class="fa-solid fa-triangle-exclamation"></i> আপনি শিক্ষার্থীর জমাকৃত ফাইল, নম্বর এবং স্ট্যাটাস সরাসরি প্রতিস্থাপন করছেন।
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>প্রাপ্ত নম্বর (ঐচ্ছিক)</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" style="background:#6366f1;border-color:#6366f1">ওভাররাইড সম্পন্ন করুন</button>
                </div>
            </form>
        </div>
    </div>
    ...
    function openGradeModal(sub) {
        document.getElementById('gradeForm').action = '/admin/assignment-submissions/' + sub.id + '/grade';
    ...
    function openOverrideModal(sub) {
        document.getElementById('overrideForm').action = '/admin/assignment-submissions/' + sub.id + '/override';
